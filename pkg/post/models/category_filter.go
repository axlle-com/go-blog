...
func (p *CategoryFilter) ValidateForm(ctx *gin.Context) (*CategoryFilter, *errors.Errors) {
	err := p.Filter.ValidateForm(ctx, p)
	return p, err
}

func (p *CategoryFilter) ValidateQuery(ctx *gin.Context) (*CategoryFilter, *errors.Errors) {
