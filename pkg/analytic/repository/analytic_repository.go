...
type AnalyticRepository interface {
	...
	WithPaginate(p contracts2.Paginator, filter *models.AnalyticFilter) ([]*models.Analytic, error)
}
...
func NewAnalyticRepo() AnalyticRepository {
...
func (r *repository) WithPaginate(p contracts2.Paginator, filter *models.AnalyticFilter) ([]*models.Analytic, error) {
	var analytics []*models.Analytic
	var total int64
